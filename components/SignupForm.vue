      ...
      <div class="mx-auto w-80 overflow-hidden rounded-2xl bg-white shadow-lg">
        <div class="px-10 py-5">
          ...
          <form class="mt-10">
            ...
            <button
              type="submit"
              class="mt-20 block w-full cursor-pointer rounded bg-rose-500 px-4 py-2 text-center font-semibold text-white hover:bg-rose-400 focus:outline-none focus:ring focus:ring-rose-500 focus:ring-opacity-80 focus:ring-offset-2">Sign Up</button>          </form>
        </div>
      </div>
    </div>
  </div>
